        ...
        <tr>
            ...
            <td>
                @foreach ($userMahasiswa->mahasiswa_semesters as $mahasiswa_semester)
                    <ul>{{$mahasiswa_semester->semester->year}} - {{$mahasiswa_semester->semester->semester}} | {{$mahasiswa_semester->semester_status->name}}</ul>
                @endforeach
            </td>
            <td>
            ...
            <td>
                {{$userMahasiswa->international_mahasiswa->international_university->name}} | {{$userMahasiswa->international_mahasiswa->international_university->country->name}}
            </td>
            <td>
            ...
            <td>
                {{$userMahasiswa->international_mahasiswa->start_at}} s/d {{$userMahasiswa->international_mahasiswa->end_at}}
            </td>
            <td>
